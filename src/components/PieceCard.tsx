...
export default function PieceCard({ p }: { p: Piece }) {
  ...
  return (
    <div onClick={() => nav(`/pieces/${p.id}`)} className="card card-tap" style={{ padding: '14px 16px', display: 'flex', gap: 13 }}>
      <WikiImage
        ...
        alt=""
        style={{ width: 58, height: 58, borderRadius: 9, flex: 'none', alignSelf: 'flex-start' }}
      />
