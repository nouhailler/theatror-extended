...
export const DECORS: Decor[] = [
  ...
  // ─── Compléments ───
  { id: 'temple', nom: 'Temple antique', categorie: 'Antique', initiale: 'T', bg: 'radial-gradient(circle at 50% 35%, #7d6f52, #3c3323)',
  ...
  { id: 'arene', nom: 'Arène / Amphithéâtre', categorie: 'Antique', initiale: 'A', bg: 'radial-gradient(circle at 50% 55%, #8a7550, #43371f)',
  ...
  { id: 'galerie', nom: 'Galerie / Antichambre', categorie: 'Palais & cour', initiale: 'G', bg: 'linear-gradient(160deg, #4a3a2a, #281d14)',
  ...
  { id: 'marche', nom: 'Marché / Halle', categorie: 'Populaire', initiale: 'M', bg: 'linear-gradient(160deg, #46372a, #271d14)',
  ...
  { id: 'foire', nom: 'Théâtre de foire', categorie: 'Populaire', initiale: 'F', bg: 'linear-gradient(160deg, #4a2c2c, #281414)',
  ...
  { id: 'guinguette', nom: 'Guinguette', categorie: 'Populaire', initiale: 'G', bg: 'linear-gradient(160deg, #34492f, #1d2c1b)',
  ...
  { id: 'reve', nom: 'Espace onirique', categorie: 'Symbolique', initiale: 'O', bg: 'radial-gradient(circle at 50% 40%, #3a2a4e, #150f22)',
  ...
  { id: 'ruines', nom: 'Ruines', categorie: 'Symbolique', initiale: 'R', bg: 'linear-gradient(160deg, #3a3630, #1c1a16)',
