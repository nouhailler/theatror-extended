...
export const COSTUMES: Costume[] = [
  ...
  // ─── Compléments ───
  { id: 'stola', nom: 'Stola romaine', epoque: 'Antiquité', pays: 'Rome', genre: 'Femme', initiale: 'S',
  ...
  { id: 'armure-chevalier', nom: 'Armure de chevalier', epoque: 'Moyen Âge', pays: 'Europe', genre: 'Homme', initiale: 'A',
  ...
  { id: 'hennin', nom: 'Hennin & robe médiévale', epoque: 'Moyen Âge', pays: 'France', genre: 'Femme', initiale: 'H',
  ...
  { id: 'bouffon', nom: 'Costume de bouffon', epoque: 'Renaissance', pays: 'Europe', genre: 'Mixte', initiale: 'B',
  ...
  { id: 'sans-culotte', nom: 'Costume de sans-culotte', epoque: 'Lumières', pays: 'France', genre: 'Homme', initiale: 'S',
  ...
  { id: 'dandy', nom: 'Habit de dandy', epoque: 'Romantique', pays: 'Angleterre / France', genre: 'Homme', initiale: 'D',
